unit DemoWebSocket.Server.Modules.DemosWebSocket;
...
var
  WebModuleClass: TComponentClass = TWebSocket;
...
uses
  DemoWebSocket.Server.Rotas.DemoWebSocket,
  System.IOUtils,
...
procedure TWebSocket.WebModuleCreate(Sender: TObject);
begin
  ...
  // Controllers
  fMVC.AddController(TServerRotasDemoWebSocket);
  // Controllers - END
...
procedure TWebSocket.WebModuleDestroy(Sender: TObject);
begin
  fMVC.Free;
end;
